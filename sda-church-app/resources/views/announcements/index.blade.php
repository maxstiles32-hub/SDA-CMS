                                ...
                                @forelse($announcements as $announcement)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium space-x-2">
                                            <a href="{{ route('announcements.edit', $announcement->announcement_id) }}" class="text-indigo-600 hover:text-indigo-900">Edit</a>
                                            <form action="{{ route('announcements.destroy', $announcement->announcement_id) }}" method="POST" class="inline" onsubmit="return confirm('Delete this announcement?');">
                                                @csrf
                                                @method('DELETE')
