<x-guest-layout>
    ...
    <div class="mb-8">
        <h2 class="text-2xl font-bold text-neutral-900">Create your password</h2>
        <p class="mt-1 text-sm text-neutral-500">
            First login detected — set a new secure password to continue.
        </p>
    </div>
    ...
    <form method="POST" action="{{ route('password.change.store') }}" class="space-y-5"
        ...
        <div>
            ...
            <x-text-input id="current_password" class="block mt-1.5 w-full" type="password"
                          name="current_password" required autocomplete="current-password" autofocus />
