...
<head>
    <meta charset="UTF-8">
    <title>Class Funds Report | SDA Church</title>
    <style>
        ...
        .receipt-badge { display: inline-block; padding: 2px 8px; border-radius: 12px; font-size: 10px; font-weight: bold; background: #d1fae5; color: #065f46; }
...
<body>
    <div class="header">
        ...
        <p>Class Funds Report</p>
        <p>Generated on {{ \Carbon\Carbon::now()->format('F j, Y, g:i a') }}</p>
    </div>

    <div class="meta">
        <strong>Records:</strong> <span>{{ $classFunds->count() }}</span> &nbsp;&nbsp;
    ...
    <div class="footer">
        SDA Church CMS &mdash; Class Funds Report &mdash; Confidential
    </div>
</body>
</html>
